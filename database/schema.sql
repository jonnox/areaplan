...
CREATE TABLE POI (id INTEGER, type INTEGER, location TEXT, level INTEGER, info TEXT, p1x INTEGER, p1y INTEGER, p2x INTEGER, p2y INTEGER, p3x INTEGER, p3y INTEGER, p4x INTEGER, p4y INTEGER, centerX INTEGER, centerY INTEGER, area INTEGER);
